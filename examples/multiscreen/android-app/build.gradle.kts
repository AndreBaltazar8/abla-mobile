...
fun ablaMobileInt(name: String): Int =
    requireNotNull(ablaMobile.getProperty(name)) { "Missing Abla Mobile property: $name" }.toInt()
fun ablaMobileString(name: String): String =
    requireNotNull(ablaMobile.getProperty(name)) { "Missing Abla Mobile property: $name" }
